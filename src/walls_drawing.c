...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/29 20:28:18 by fermelin          #+#    #+#             */
/*   Updated: 2020/10/29 20:28:31 by fermelin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	line_drawing(t_all *all, double slice_height, int txt_nbr, int texture_x, double height_diff)
{
	int 	y;
	int 	y1;
	int 	color;
